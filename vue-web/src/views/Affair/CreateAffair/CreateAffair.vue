<template>
    <div class="EditorAffairPanel" v-if="showPanel">
        <div class="PushAlert">
            ...
            <input type="text" v-model="Editor.NewAffair.name" class="NewAffairName" placeholder="新事务名称" title="名称" />
            <input type="text" v-model="Editor.NewAffair.describe" class="NewAffairDescribe" placeholder="新事务描述"
                title="描述" />
